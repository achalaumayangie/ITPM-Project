        ...
        <br></br>
          <form className="row" onSubmit={this.onSubmit} style={{ margin:"25px 85px 75px 100px"}} >
            ...
            <table>
                 <tr>
                     <td>
            <button className="btn btn-success" type="submit" style={{margin:"25px 40px 75px -65px"}} >
              <i className="far fa-check-square"></i>
              &nbsp; Save
            </button>
            </td>
            <td>
            <button className="btn btn-success" style={{margin:"0px 90px 45px 0px"}}><a href="/Home" style={{textDecoration:'none',color:'white'}}>Log in</a></button>
            </td>
            </tr>
            </table>
            </form>
